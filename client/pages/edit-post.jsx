        ...
        <form id="post-form" onSubmit={this.handleSubmit} className="text-muted">
          ...
          <div className="row">
            <div className="col-sm-6 w-25 p-3">
              <button type="submit" className="button my-3">Update</button>
            </div>
            <div className="col-sm-6 w-25 p-3">
              <button type="button" className="button m-3" data-bs-toggle="modal"
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      ...
                      <button onClick={this.handleDelete} type="button" data-bs-dismiss="modal" className="button-delete">Delete</button>
                    </div>
                  </div>
                </div>
              </div>
